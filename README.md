...
### **Что сделано:**
- верстка по макету, адаптивная верстка (не должна ломается при разрешениях от 320px до 1920px)
...
- рефактиринг с  Typescript
- рефакторинг - доработать код  так, чтобы его  было удобно и интуитивно понятно, как заново использовать 
- обработка ошибок - некорректных данных при ошибках API-запроса (status code !== 200)
- описание, как тестировался результат работы. Написание тестов. Описание инструмеетов  и как  осуществлялось тестирование
